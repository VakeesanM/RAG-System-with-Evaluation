...
### Intalize Vector database, Embedder and Splitter
Embedder = OpenAIEmbeddings(model='text-embedding-3-small')

splitter = RecursiveCharacterTextSplitter(chunk_size=1000, chunk_overlap=200)

### Adding Value to VectorDB
...
Greek_Mythos = PyPDFLoader(r"RAGSystem\Greek_Mythology.pdf").load()
...
vectorDB = FAISS.from_documents(Combined_doc, embedding=Embedder)
